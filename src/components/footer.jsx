      ...
      <div className='w-full laptop:max-w-[1152px] px-4 tablet:px-6 laptop:px-8 xl:px-0  mx-auto py-[40px] tablet:py-[80px] laptop:py-[100px]'>
        <div className='flex flex-col laptop:flex-row laptop:items-start laptop:justify-between text-white'>
          ...
          <div className='flex flex-col gap-3 desktop:gap-4 text-white font-bold text-left'>
            ...
            <Link smooth href='/#works' className='text-sm text-white laptop:text-[16px] leading-[22px] flex gap-2'> <img src={Phone} alt="" />(+234) 8100-0000-00</Link>
            <Link smooth href='/#faq' className='text-sm text-white laptop:text-[16px] leading-[22px]  flex gap-2'> <img src={Map} alt="" />009 Marina Lagos, Nigeria</Link>
            <Link smooth href='/#pricing' className='text-sm laptop:text-[16px] leading-[22px] text-white flex gap-2'> <img src={Email} alt="" />Arya@example.com</Link>
          </div>
