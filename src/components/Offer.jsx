  ...
  return (
    <>
      ...
      <section className='bg-white'>
          ...
          <div className='flex justify-center items-center gap-7 shrink-0'>
            <div className='group flex flex-col items-center justify-center w-96 h-96 p-8 shrink-0 bg-secondary hover:bg-primary rounded-2xl gap-9'>
              ...
              <div className='text-center space-y-3 group-hover:text-white'>
                ...
                <Link to="/app" className='group/link transition-all duration-300 ease-in-out flex items-center justify-center gap-1 text-primary group-hover:text-white '>
        ...
        {/* Newsletter */}
        <div className='flex flex-col items-center justify-center p-6 -mt-2 md:p-16 gap-12 bg-primary rounded-t-xl'>
